...
// Assure que l'admin puisse créer des résevartions - utiles pour les tests
$admin_role = get_role('administrator'); 
if (! $admin_role -> has_cap('create_pk_reservations')) {
    $admin_role -> add_cap('create_pk_reservations');
}
